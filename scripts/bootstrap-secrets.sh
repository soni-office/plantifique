...
push_secret "plantifique-${ENV}-tikapi-key"            "TIKAPI_KEY"
push_secret "plantifique-${ENV}-redis-url"             "REDIS_URL"
push_secret "plantifique-${ENV}-internal-api-secret"   "INTERNAL_API_SECRET"
